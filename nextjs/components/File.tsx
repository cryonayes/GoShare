                        ...
                        <div className="row align-items-center no-gutters">
                            ...
                            <div className="col-auto">
                                <div className="dropdown no-arrow">
                                    <button id={`button-${props.dropdownID}`} className="btn btn-primary" onClick={dropDownClicked} type="button" style={{background: "transparent", color: "black", padding: "0px", width: "1.5rem", height: "1.5rem", border: "none", outline: "none" }}>
                                    ...
                                    <div id={`dropdown-${props.dropdownID}`} className="dropdown-menu flex-column" style={{padding: "0px", overflow: "hidden"}}>
                                        <a className="dropdown-item" href="#"><i className="fas fa-save pr-2"/>Download</a>
