                    ...
                    <div className="card-body">
                        <div className="row align-items-center no-gutters">
                            ...
                            <div className="col-auto">
                                <DropdownMenu onDeleteFile={props.onDeleteFile} onShare={props.onShareFile} onUnshare={props.onUnshareFile}
                                              fileAccessCode={props.fileAccessCode} shared={props.shared} refresh={props.refresh}/>
                            </div>
                        </div>
                    </div>
                </div>
